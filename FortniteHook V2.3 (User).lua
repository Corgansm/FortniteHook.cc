...
--[[  Changelogs
    Added   
      [+] WaterMark + Configs Folder

    Fixes
      [!] Fixing Luas Folder Later

    Upcoming Updates
      [*] Depends On What Corgan And Doggo Wants To Do 
]]

getgenv().values = {}
local library = loadstring(game:HttpGet'https://raw.githubusercontent.com/CatzCode/PikaHub/main/Libraries/UI/bruh.lua')()
library:CreateWatermark("FortniteHook 卐 Beta Build 卐 V1.0")
...
for _,lua in pairs(listfiles("aristoislua")) do
	local luaname = GSUB(lua, "aristoislua\\", "")
