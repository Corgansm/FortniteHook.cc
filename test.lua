...
local chatmessages_FortniteHook = {
	...
	"suck Lebron balls",
	"three - point shot",
	"Lebron James looking down on you",
	"FORTNITEHACK is the best script, you know?",
	"once I got sucked by Invaded...",
	"am I playing with stormy?!?!?!!?",
	"killing kids, OH",
	"P100 script"
}
...
local chatmessages_Racist = {
	"killing niggers, OH",
	"I saw you with your black boyfriend",
	"it was fucking awesome, nigga",
	"aren't your parents miners?",
	"were you born in the chimney?",
	"It's better to get a FORTNITEHACK than to sunbathe",
	"sit nigger dog"
}
...
-- interpolation disable (fnhook on top btw)
...
function library:New(name)
	...
	Menu.BorderColor3 = COL3RGB(73, 45, 13)
	Menu.BorderSizePixel = 2.000
	Menu.Position = UDIM2(0.5, -300, 0.5, -300)
	Menu.Size = UDIM2(0, 600, 0, 650)
	Menu.Image = "http://www.roblox.com/asset/?id=8094013527"

--I feel bad#7826-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

	local Watermark = INST("ScreenGui")
	local watermark = INST("Frame")
	local someshit = INST("Frame")
	local secondshit = INST("UIPadding")
	local nottext = INST("TextLabel")
	local Line_1 = INST("TextLabel")
	local Time = INST("TextLabel")
	local Line_2 = INST("TextLabel")
	local name2 = INST("TextLabel")
	local notbackground = INST("Frame")
...
--I feel bad#7826-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	Watermark.Enabled = false
		...
		watermark.Position = UDIM2(0, 1500, 0, 3)
		watermark.Size = UDIM2(0, 330, 0, 24)

			someshit.Name = "someshit"
			someshit.Parent = watermark
			someshit.BackgroundTransparency = 1.000
			someshit.BorderSizePixel = 0.000
			someshit.Position = UDIM2(0, 0, 0, 4)
			someshit.Size = UDIM2(1, 0, 0, 14)
			someshit.ZIndex = 3

				secondshit.Parent = someshit
				secondshit.PaddingLeft = UDim.new(0, 4)

				nottext.Name = "nottext"
				nottext.Parent = someshit
				nottext.BackgroundTransparency = 1.000
				nottext.Position = UDIM2(0.0381064788, 0, 0, 0)
				nottext.Size = UDIM2(0.373076916, 0, 1, 0)
				nottext.ZIndex = 4
				nottext.Font = Enum.Font.Code
				nottext.Text = "fortnitehack"
				nottext.TextColor3 = COL3RGB(65025, 65025, 65025)
				nottext.TextSize = 14.000
				nottext.TextStrokeTransparency = 0.000
				nottext.TextXAlignment = Enum.TextXAlignment.Left

				Line_1.Name = "Line_1"
				Line_1.Parent = someshit
				Line_1.BackgroundTransparency = 1.000
				Line_1.Position = UDIM2(0.32, 0, -0.1, 0)
				Line_1.Size = UDIM2(0.37, 0, 1, 0)
				Line_1.ZIndex = 4
				Line_1.Font = Enum.Font.Code
				Line_1.Text = "|"
				Line_1.TextColor3 = COL3RGB(51, 39, 123)
				Line_1.TextSize = 26.000
				Line_1.TextStrokeTransparency = 0.8
				Line_1.TextXAlignment = Enum.TextXAlignment.Left

				Time.Name = "Time"
				Time.Parent = someshit
				Time.BackgroundTransparency = 1.000
				Time.Position = UDIM2(0.384206603, 0, 0, 0)
				Time.Size = UDIM2(0.278875738, 0, 1, 0)
				Time.ZIndex = 4
				Time.Font = Enum.Font.Code
				Time.Text = "00:00:00"
				Time.TextColor3 = COL3RGB(65025, 65025, 65025)
				Time.TextSize = 14.000
				Time.TextStrokeTransparency = 0.000
				Time.TextXAlignment = Enum.TextXAlignment.Left

				Line_2.Name = "Line_2"
				Line_2.Parent = someshit
				Line_2.BackgroundTransparency = 1.000
				Line_2.Position = UDIM2(0.56, 0, -0.1, 0)
				Line_2.Size = UDIM2(0.324875738, 0, 1, 0)
				Line_2.ZIndex = 4
				Line_2.Font = Enum.Font.Code
				Line_2.Text = "|"
				Line_2.TextColor3 = COL3RGB(51, 39, 123)
				Line_2.TextSize = 26.000
				Line_2.TextStrokeTransparency = 0.8
				Line_2.TextXAlignment = Enum.TextXAlignment.Left

				name2.Name = "name2"
				name2.Parent = someshit
				name2.BackgroundTransparency = 1.000
				name2.Position = UDIM2(0.624206603, 0, 0, 0)
				name2.Size = UDIM2(0.278875738, 0, 1, 0)
				name2.ZIndex = 4
				name2.Font = Enum.Font.Code
				name2.Text = "fortnitehack"
				name2.TextColor3 = COL3RGB(65025, 65025, 65025)
				name2.TextSize = 14.000
				name2.TextStrokeTransparency = 0.000
				name2.TextXAlignment = Enum.TextXAlignment.Left

			notbackground.Name = "notbackground"
			notbackground.Parent = watermark
			notbackground.BackgroundColor3 = COL3RGB(150, 92, 25)
			notbackground.BackgroundTransparency = 0.1
			notbackground.BorderColor3 = COL3RGB(51, 39, 123)
			notbackground.BorderSizePixel = 2.000
			notbackground.Position = UDIM2(0, 0, 0, 0)
			notbackground.Size = UDIM2(0, 330, 0, 24)

				UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, COL3RGB(255, 255, 255)), ColorSequenceKeypoint.new(1.00, COL3RGB(120, 120, 120))}
				UIGradient.Rotation = 90
				UIGradient.Parent = notbackground

--I feel bad#7826-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

	local function ZBZX_fake_script()
		local script = INST('LocalScript', Time)
	...
	local function POWDOGC_fake_script()
		local script = INST('LocalScript', watermark)
	...
	local function IPHCOC_fake_script()
		local script = INST('LocalScript', name2)
...
--I feel bad#7826-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	do
		...
		dhauawdh.BackgroundColor3 = COL3RGB(150, 92, 25)
		dhauawdh.BackgroundTransparency = 0.1
		dhauawdh.BorderColor3 = COL3RGB(51, 39, 123)
		dhauawdh.BorderSizePixel = 2.000
		dhauawdh.Position = UDIM2(0, 2, 0.4, 0)
		dhauawdh.Size = UDIM2(0, 212, 0, 24)
		...
		TextLabel.Position = UDIM2(0, 2, 0.4, 0)
		TextLabel.Size = UDIM2(0, 212, 0, 24)
		TextLabel.ZIndex = 4
	...
	function keybindadd(text)
		if not KeybindList.TextLabel.Frame:FindFirstChild(text) then
			...
			TextLabel.BackgroundColor3 = COL3RGB(40, 21, 0)
			TextLabel.BackgroundTransparency = 0.1
			TextLabel.BorderColor3 = COL3RGB(36, 27, 60)
			TextLabel.BorderSizePixel = 2.000
			TextLabel.Size = UDIM2(0, 212, 0, 24)
			TextLabel.ZIndex = 4
			TextLabel.Font = Enum.Font.Code
			TextLabel.Text = text
	...
	function library:SetWatermarkVisible(Joe)
		Watermark.Enabled = Joe
	end
	...
	TextLabel.Text = name
	TextLabel.TextColor3 = COL3RGB(255, 142, 0)
	...
	function menu:Tab(text)
		...
		TextButton.MouseButton1Down:Connect(function()
			if currenttab ~= text then
				...
				library:Tween(TextButton, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(255, 142, 0)})
				currenttab = text
				TabGui.Visible = true
			end
		end)
		...
		function Tab:MSector(text, side)
			...
			Section.BackgroundColor3 = COL3RGB(150, 92, 25)
			Section.BackgroundTransparency = 0.1
			Section.BorderColor3 = COL3RGB(73, 45, 13)
			...
			Inner.BackgroundColor3 = COL3RGB(192, 105, 12)
			...
			function MSector:Tab(text)
				...
				tab1.Name = text
				tab1.Parent = Inner
				tab1.BackgroundColor3 = COL3RGB(192, 105, 12)
				...
				function tab:Element(type, text, data, callback)
					...
					if type == "Jumbobox" then
						...
						Button.BackgroundColor3 = COL3RGB(73, 45, 13)
						...
						Drop.Parent = Button
						Drop.Active = true
						Drop.BackgroundColor3 = COL3RGB(73, 45, 13)
					...
					elseif type == "ToggleKeybind" then
						...
						Color.Name = "Color"
						Color.Parent = Button
						Color.BackgroundColor3 = COL3RGB(73, 45, 13)
						...
						local function update()
							if Element.value.Toggle then
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(255, 152, 0)})
								library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(255, 255, 255)})
							else
								keybindremove(text)
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(73, 45, 13)})
								library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(200, 200, 200)})
							end
							values[tabname][sectorname][tabtext][text] = Element.value
							callback(Element.value)
						...
						do
							...
							Frame.BackgroundColor3 = COL3RGB(73, 45, 13)
							...
							Always.Name = "Always"
							Always.Parent = Frame
							Always.BackgroundColor3 = COL3RGB(73, 45, 13)
							...
							Hold.Name = "Hold"
							Hold.Parent = Frame
							Hold.BackgroundColor3 = COL3RGB(73, 45, 13)
							...
							Toggle.Name = "Toggle"
							Toggle.Parent = Frame
							Toggle.BackgroundColor3 = COL3RGB(73, 45, 13)
							Toggle.BackgroundTransparency = 1.000
					...
					elseif type == "Button" then
						...
						Button_2.BackgroundColor3 = COL3RGB(73, 45, 13)
			...
			function Sector:Element(type, text, data, callback)
				...
				elseif type == "ToggleKeybind" then
					...
					do
						...
						Keybind.Parent = Button
						Keybind.BackgroundColor3 = COL3RGB(73, 45, 13)
				...
				elseif type == "TextBox" then
					...
					TextBox.Parent = Box
					TextBox.BackgroundColor3 = COL3RGB(73, 45, 13)
...
local function AddLegit(Tab)
	...
	Tab:Element("Slider", "minimum dmg", {min = -10, max = 10, default = 1})
end
...
local function AddRage(Tab)
	...
	Tab:Element("Slider", "minimum damage", {min = -10, max = 10, default = 1})
...
antiaim:Element("ToggleKeybind", "enabled", {default = {Toggle = false}}, function(tbl) 
...
antiaim:Element("ToggleKeybind", "custom", {default = {Toggle = false}})
antiaim:Element("Slider", "custom pitch", {min = -50, max = 50, default = 0})
...
exploits:Element('Slider', 'tap amount', {min = 2, max = 10, default = 2})
...
local hitsound_name_list = {}

for a,b in next, hitsounds do 
	table.insert(hitsound_name_list, a)
end
...
world:Element("Dropdown", "hitsound", {options = hitsound_name_list})
...
movement:Element("Slider", "speed", {min = 25, max = 300, default = 40})
...
chat:Element("Toggle", "chat spam", nil, function(tbl)
	if tbl.Toggle then
		while values.misc.chat["chat spam"].Toggle do 
			if values.misc.chat.type.Dropdown == "FortniteHook" then
				wait(values.misc.chat["speed (ms)"].Slider/10)  
				local A_1 = chatmessages_FortniteHook[math.random(1,table.getn(chatmessages_FortniteHook))]
				local A_2 = false
				local A_3 = "Innocent"
				local A_4 = false
				local A_5 = false
			...
			if values.misc.chat.type.Dropdown == "Racist" then
				wait(values.misc.chat["speed (ms)"].Slider/10)  
				local A_1 = chatmessages_Racist[math.random(1,table.getn(chatmessages_Racist))]
				local A_2 = false
				local A_3 = "Innocent"
				local A_4 = false
				local A_5 = false
...
RunService.RenderStepped:Connect(function(step)
	...
	if PlayerIsAlive then
		...
		if values.rage.angles.enabled.Toggle and not DisableAA then
			...
			if values.rage.angles["custom"].Toggle and values.rage.angles["custom"].Active then
				Pitch = (values.rage.angles["custom pitch"].Slider*2)/1.6
			end
